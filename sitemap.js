/* rawgit url (https://cdn.rawgit.com/D-dig/js/gh-pages/sitemap1.js) by http://www.ardilas.com */ var postTitle = new Array();
...
function displayToc(a) {
    ...
    for (var g = 0; g < postTitle.length; g++) {
        if (a == "") {
            h +=
                '<tr><td class="toc-entry-col1"><a href="' +
                postUrl[g] +
                '">' +
                postTitle[g] +
                ...
                postLabels[g] +
                '</td><td class="toc-entry-col4"><a href="' +
                postMp3[g] +
                '">Download</a></td></tr>';
            l++;
        } else {
